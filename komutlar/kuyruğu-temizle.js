...
.setDescription(`<a:basarili:755010328886247484>  | Müzik Kuyruğu, ${message.author} tarafından temizlendi.`) 
...
.setTitle("• Hata: 011 •")
.setThumbnail(message.author.displayAvatarURL({format : "gif"}))
.setDescription(`<a:hata:755010329787760640>  | Müzik Kuyruğunu temizleyebilmek için bir ses kanalında olmanız gerekmektedir!`)
.setFooter(`Alone Music © 2020 - All right reserved.`, client.user.avatarURL());  
